    ...
    >
      <div tabIndex={-1} className="flex w-full max-w-2xl flex-col gap-4 rounded-2xl border border-border bg-bg-surface p-4 focus:outline-none">
        ...
        <div className="flex gap-3">
          ...
          <button type="button" onClick={handleConfirm} disabled={working || !completed} className="min-h-[48px] flex-1 rounded-xl bg-accent px-6 text-sm font-semibold text-accent-ink hover:bg-accent/90 disabled:cursor-not-allowed disabled:bg-bg-elevated disabled:text-text-muted">
